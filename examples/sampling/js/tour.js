...
function tour() {
    ...
    tour.addStep({
      ...
      text:
          "<p>One of the features offered by Interactive Map Layers is data sampling. Data sampling makes possible to efficiently render an excerpt of a very large data set for visual reference and analysis, without the need to transfer all the data to the client.</p>"+
